              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Coloque seus dados para criar a conta</p>
                  </div>

                  <form class="row g-3 needs-validation" action="register_valida.php" method="post">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Por favor coloque um usuário!</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Ja possui login? <a href="index.php">Log in</a></p>
                    </div>
                  </form>
